        ...
        >
          <li className="mr-5 text-xs">
            <a
              ...
              href="https://www.facebook.com/share/1D8qSipY1j/"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li className="mr-5 text-xs">
            <a
              className="block hover:text-white"
              href="https://www.linkedin.com/in/farazgul777"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li className="mr-5 text-xs">
            <a
              className="block hover:text-white"
              href="https://github.com/farazgulofficial"
              target="_blank"
              rel="noreferrer"
            >
