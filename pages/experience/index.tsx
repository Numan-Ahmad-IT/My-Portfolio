              ...
              <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-2">
                  ...
                  <Image
                    ...
                    src={"/images/experiences/canvas.jpeg"}
                  />
                </div>
                <div className="z-10 sm:col-span-6">
                  <h3 className="font-medium leading-snug text-slate-200">
                    <div>
                      ...
                      >
                        ...
                        <span>
                          DevOps Engineer – Azure/AWS Platforms {" . "}
                          <span className="inline-block">
                            Canvas Reply - Beiersdorf  - Germany, Braunschweig{" "}
                            <svg
                  ...
                  <div className="mt-2 text-sm leading-normal text-justify">                
                    ...
                    <ul>
                      <li>Delivered high-quality .NET and API-driven enterprise solutions within Azure DevOps CI/CD pipelines, implementing continuous testing with
                          Playwright and Cypress, API validation via Postman, performance testing using JMeter, GTmetrix, and Lighthouse, defect tracking in
                          Jira/TestRail, system monitoring through Azure Application Insights, close Agile collaboration in Visual Studio, and test framework
                          improvements aligned with cloud architecture, UX/UI, and AI/data-driven validation.</li>
              ...
              <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-2">
                  ...
                  <Image
                    ...
                    className="rounded transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
                    style={{ color: "transparent" }}
                    src={"/images/experiences/reply.jpeg"}
                  />
                </div>
                <div className="z-10 sm:col-span-6">
                  <h3 className="font-medium leading-snug text-slate-200">
              ...
              <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-2">
                  ...
                  <Image
                    ...
                    className="rounded transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
                    style={{ color: "transparent" }}
                    src={"/images/experiences/accenture.jpeg"}
                  />
                </div>
                <div className="z-10 sm:col-span-6">
                  <h3 className="font-medium leading-snug text-slate-200">
